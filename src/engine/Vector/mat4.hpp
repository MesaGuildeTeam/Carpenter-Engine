...
class mat4 {
    ...
    // forwards iterator
    using iterator = std::array<vec4,N>::iterator;
    // const forwards iterator
    using const_iterator = std::array<vec4,N>::const_iterator;
    // reverse iterator
    using reverse_iterator = std::array<vec4,N>::reverse_iterator;
    // const reverse iterator
    using const_reverse_iterator = std::array<vec4,N>::const_reverse_iterator;
